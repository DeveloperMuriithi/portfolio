...
export const Contact = () => {
  ...
  return (
    <section
    id="contact"
    className="min-h-screen items-center px-4 py-20 flex flex-col justify-start sm:justify-center "
    >
      <RevealOnScroll>
        <div className="w-full min-w-0 max-w-2xl px-4 sm:px-6 lg:px-8 mx-auto">
